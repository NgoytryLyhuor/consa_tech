                ...
                <div class="container-fluid">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Chemical ingredient and equipment service</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="card-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php
                                            ...
                                            $sql_select = "SELECT * FROM tbl_service WHERE id = 5";
                                            ...
                                            echo '
                                                ...
                                                echo '
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="image" class="col-sm-12 col-form-label"></label>
                                                        <div class="col-sm-12">
                                                            <button type="submit" name="btn_service_five" class="btn btn-info waves-effect waves-light">Insert News Data</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ';
