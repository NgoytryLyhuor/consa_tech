        ...
        <div class="container-fluid">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Announcement Activities</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="container">
                                    <?php
                                        $sql_select = "SELECT * FROM tbl_announcement WHERE id = $update_id";
                                        ...
                                        echo '
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <img class="rounded me-2 showImage1" alt="200x200" height="200" src="./assets/images/announcement/'.$row['banner'].'" data-holder-rendered="true">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-12">
                                                    <input class="form-control" type="date" value="'.$row['date'].'" name="date"required>
                                                </div>
                                            </div>
