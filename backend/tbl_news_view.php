                                    ...
                                    if ($result != '') {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            echo '
                                                <tr>
                                                    <td>
                                                        <img width="100px" src="./assets/images/news_banner/' . $row['banner'] . '" alt="">
                                                    </td>
                                                    <td align="left">
                                                        ' . $row['title'] . '
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-info waves-effect waves-linght" href="./tbl_news_update.php?id=' . $row['id'] . '">Update</a>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="" method="post">
                                                ...
                                                <button type="submit" name="btn_news_delete" class="btn btn-danger">Delete</button>
                                            </form>
                                        </div>
