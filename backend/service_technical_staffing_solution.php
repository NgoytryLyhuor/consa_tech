                ...
                <div class="container-fluid">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Technical Staffing Solution Service</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                            ...
                                            echo '
                                                ...
                                                echo '
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="image" class="col-sm-12 col-form-label"></label>
                                                        <div class="col-sm-12">
                                                            <button type="submit" name="btn_service_two" class="btn btn-info waves-effect waves-light">Insert News Data</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ';
